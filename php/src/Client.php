...
/**
 * Client for the Dice Roller API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/diceroller?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/diceroller';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DicerollerClient] {$message}\n";
        }
    }
}
