...
```gradle
dependencies {
    implementation 'com.github.apiverve:diceroller-api:1.1.13'
}
```
...
```java
import com.apiverve.diceroller.DiceRollerAPIClient;
import com.apiverve.diceroller.APIResponse;
import com.apiverve.diceroller.APIException;

// Initialize the client
DiceRollerAPIClient client = new DiceRollerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("dice", "1d6");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/diceroller](https://docs.apiverve.com/ref/diceroller)
...
- **Documentation:** [https://docs.apiverve.com/ref/diceroller](https://docs.apiverve.com/ref/diceroller)
- **Issues:** [GitHub Issues](https://github.com/apiverve/diceroller-api/issues)
