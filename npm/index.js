...
class dicerollerWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/diceroller');
        }
        ...
        this.validationRules = {"dice":{"type":"string","required":false,"default":"1d6"},"modifier":{"type":"integer","required":false,"default":0}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/diceroller`);
        }
    }
...
module.exports = dicerollerWrapper;
