# Dice Roller API - Examples

This folder contains example code for using the Dice Roller API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/diceroller',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/diceroller");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/diceroller](https://docs.apiverve.com/ref/diceroller)
