...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/diceroller',
        'Source': 'https://github.com/apiverve/diceroller-api',
        'Bug Tracker': 'https://github.com/apiverve/diceroller-api/issues'
    },
    classifiers=[
