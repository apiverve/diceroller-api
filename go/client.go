...
const (
	baseURL        = "https://api.apiverve.com/v1/diceroller"
	defaultTimeout = 30 * time.Second
)

// Client is the Dice Roller API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Dice Roller API client.
...
// Execute makes a request to the Dice Roller API with typed parameters.
//
