...
namespace APIVerve.API.DiceRoller
{
    ...
    /// <summary>
    /// Client for the DiceRoller API
    /// </summary>
    public class DiceRollerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/diceroller";
        ...
        {
            { "dice", new ValidationRule { Type = "string", Required = false } },
            { "modifier", new ValidationRule { Type = "integer", Required = false } }
        };
        ...
        public DiceRollerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DiceRollerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DiceRollerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DiceRollerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DiceRollerQueryOptions options)
        {
        ...
        public ResponseObj Execute(DiceRollerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DiceRollerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DiceRollerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DiceRollerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DiceRollerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DiceRollerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DiceRollerQueryOptions options)
        {
